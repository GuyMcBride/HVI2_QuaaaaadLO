...
from Configuration import (Config, loadConfig, 
                           Fpga, PcFpgaRegister, HviFpgaRegister,
...
if (__name__ == '__main__'):
    ...
    pcFpgaRegisters = [PcFpgaRegister('PC_CH1_PhaseSel', mode),
                      PcFpgaRegister('PC_CH1_PhaseInc0A', A(lo1_1_0)),
                      PcFpgaRegister('PC_CH1_PhaseInc0B', B(lo1_1_0)),
                      PcFpgaRegister('PC_CH1_PhaseInc1A', A(lo1_1_1)),
                      PcFpgaRegister('PC_CH1_PhaseInc1B', B(lo1_1_1)),
                      PcFpgaRegister('PC_CH1_PhaseInc2A', A(lo1_1_2)),
                      PcFpgaRegister('PC_CH1_PhaseInc2B', B(lo1_1_2)),
                      PcFpgaRegister('PC_CH1_PhaseInc3A', A(lo1_1_3)),
                      PcFpgaRegister('PC_CH1_PhaseInc3B', B(lo1_1_3))]
    
    # HvcFpgaRegister:
    #   #1 - name of register
    #   #2 - value to be written
    hviFpgaRegisters = [HviFpgaRegister('RegisterBank_PhaseReset', 0)]
    # Fpga:
    #   #1 - filename of bit image
    #   #2 - list of writable register values
    fpga1 = Fpga("./FPGA/QuadLoCh1_4_00_95.k7z", pcFpgaRegisters)
